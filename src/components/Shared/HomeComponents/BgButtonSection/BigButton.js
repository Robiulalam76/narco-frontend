...
const BigButton = () => {
    return (
        <Link target="_blank" to={pdf} className='h-96 md:h-[600px] w-full grid md:grid-cols-2 items-center gap-4 p-10 md:p-20 rounded-3xl mt-40 bg-primary hover:bg-darkPrimary duration-500 cursor-pointer'>
            ...
            <div className='flex flex-col justify-end items-end gap-8 w-full h-full'>
                ...
                <h1 className='text-white font-bold text-5xl'>تعّرف علينا أكثر</h1>
            </div>
        </Link>
    );
};
