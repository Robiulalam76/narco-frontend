    ...
    return (
        <div data-aos={service?.animation}
            ...
            <div className='flex flex-col md:items-end gap-2 md:gap-6 py-8 px-4 md:px-4'>
                <h1 className='text-3xl font-bold text-right text-secondary primaryFont'>{service?.title}</h1>
                <p className='text-sm text-right text-secondary primaryFont'>{service?.description}</p>
            </div>
